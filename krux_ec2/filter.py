...
class Filter(MutableMapping):
    ...
    :example:
        ...
        Furthermore, for a quick and dirty solution, you can use keyword argument of the __init__().
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param args: Ordered arguments. If there is one, the first argument is used as the basis of this filter
        :type args: list
        :param kwargs: Keyword arguments. All keyword arguments are added to this filter
        :type kwargs: dict
        """
        self._filter = args[0] if len(args) > 0 else {}
    ...
    def to_filter(self):
        """
        Returns a list of dictionaries that can be passed to Boto3's filtering methods.

        :return: A list of dictionaries in a format expected by Boto3.
        :rtype: list[dict]
        """
        return [
